        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // здесь по сути самодельный виджет выполняющий функцию аналогичную какому ни будь FlatActionButton — наглядный пример гибкости фреймворка. 
              // Все виджеты Flutter так или иначе построены по этому принципу, из базовых блоков, комбинируясь с между собой, создаются более сложные
              InkWell(
